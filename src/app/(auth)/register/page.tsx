    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 dark:bg-gray-900 p-4">
      <div className="w-full max-w-md bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-2xl shadow-xl p-8 border border-white/20 dark:border-gray-700/50">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">Create a new account</p>
        </div>
        ...
        <div className="mt-6 text-center text-sm text-gray-500 dark:text-gray-400">
          ...
          <a href="/login" className="text-blue-600 hover:text-blue-500 dark:text-blue-400 font-medium transition-colors">
            Log in
          </a>
        </div>
      </div>
